...
pub trait Map {
    fn new() -> Self;
    fn can_place_tile(&self, tile: &MarsTile, x: i32, y: i32) -> bool;
    fn add(self, x: i32, y: i32, tile: MarsTile) -> Self;
...
mod tests {
    ...
    fn to_string<T>(something: T) -> String where T: std::fmt::Debug {
        format!("{:?}", something)
    }
